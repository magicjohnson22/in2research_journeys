...
### Highlights
- This week, I started to train the actual datasets (Mobious and openEDS data) on the local CPU device. Miguel Xochiale had requested the full dataset of MOBIOUS for the research so I moved from training the model with the sample data from Github to training it with the lighter-weight model(DEEPLAB).
